...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Book appointments anytime, anywhere, even outside business hours",
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
  ...
  },
  {
    ...
    description: "Book appointments free of charge - no hidden fees or charges",
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Experience healthcare booking made simple and convenient
          </p>
        </div>
